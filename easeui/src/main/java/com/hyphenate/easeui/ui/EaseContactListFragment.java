...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        vv=inflater.inflate(R.layout.ease_fragment_contact_list, container, false);
        iv_add= (ImageView) vv.findViewById(R.id.iv_add);
        iv_search= (ImageView) vv.findViewById(R.id.iv_search);
        return vv;
    }
    ...
    protected void setUpView() {
        Log.i("yui","9999999999999999999999");
        EMClient.getInstance().addConnectionListener(connectionListener);
        
        contactList = new ArrayList<EaseUser>();
        //从数据库中获取好友列表
        Log.i("yui","00000000000000000");
        getContactList();
        Log.i("yui","44444444444444444");
    ...
    protected void getContactList() {
        ...
        Log.i("yui","1111111111111111");
        contactList.clear();
        if(contactsMap == null){
            return;
        }
        Log.i("yui","22222222222222222");
