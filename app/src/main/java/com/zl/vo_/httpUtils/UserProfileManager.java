...
public class UserProfileManager {
	...
	public synchronized boolean init(Context context) {
		...
		HttpsManager.getInstance().onInit(context);
	...
	public void asyncFetchContactInfosFromServer(List<String> usernames, final EMValueCallBack<List<EaseUser>> callback) {
		...
		HttpsManager.getInstance().getContactInfos(usernames, new EMValueCallBack<List<EaseUser>>() {
	...
	public boolean updateCurrentUserNickName(final String nickname) {
		boolean isSuccess = HttpsManager.getInstance().updateParseNickName(nickname);
		if (isSuccess) {
	...
	public String uploadUserAvatar(byte[] data) {
		String avatarUrl = HttpsManager.getInstance().uploadParseAvatar(data);
		if (avatarUrl != null) {
	...
	public void asyncGetCurrentUserInfo() {
		HttpsManager.getInstance().asyncGetCurrentUserInfo(new EMValueCallBack<EaseUser>() {
	...
	public void asyncGetUserInfo(final String username, final EMValueCallBack<EaseUser> callback){
		HttpsManager.getInstance().asyncGetUserInfo(username, callback);
	}
	 ...
	 * @param entity
	 */
	public void saveCurrentInfo(LoginEntity entity) {
		setCurrentUserNick(entity.getUser().getNike());
		setCurrentUserAvatar(entity.getUser().getAvatar());
