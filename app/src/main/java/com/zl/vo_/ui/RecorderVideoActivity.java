...
public class RecorderVideoActivity extends BaseActivity implements
	...
	private boolean initRecorder(){
		...
		mediaRecorder.setVideoEncodingBitRate(3*1024*1024);//原来值 384 * 1024
