...
public class PracyFriendDialog extends Dialog {
    ...
    public PracyFriendDialog(Context context) {
    ...
    public static class Builder{
        PracyFriendDialog dialog;
        public Builder(Context context) {
            dialog=new PracyFriendDialog(context);
        }
        ...
        public PracyFriendDialog create(){
            return  dialog;
        }
