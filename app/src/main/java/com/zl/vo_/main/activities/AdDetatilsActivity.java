...
public class AdDetatilsActivity extends VoBaseActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if(keyCode==KeyEvent.KEYCODE_BACK){
            if(mWebView.canGoBack()){
                ...
                if(EMClient.getInstance().isLoggedInBefore()&& myUtils.readUser(AdDetatilsActivity.this)!=null){
                    startActivity(new Intent(AdDetatilsActivity.this, MainActivity.class));
                    finish();

                }else {
                    startActivity(new Intent(AdDetatilsActivity.this, LoginActivity.class));
                    finish();
